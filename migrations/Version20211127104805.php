 ...
 */
final class Version20211127104805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE advert ALTER state SET DEFAULT \'draft\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE advert ALTER state DROP DEFAULT');
    }
}
